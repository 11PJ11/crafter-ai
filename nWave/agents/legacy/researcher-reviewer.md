...
agent:
  ...
  # Review-focused variant using Haiku model for cost efficiency
    ...
    core_principles:
      ...
      - "Output Path Restriction - Write research outputs to docs/research/ OR data/research/ directory; embed files to embed/{agent}/"
...
safety_framework:
  layer_1_input_validation:
    ...
    - "Sanitize file paths - restrict to docs/research/, data/research/, or embed/{agent}/ directories only"
  ...
  layer_3_behavioral_constraints:
    tool_restrictions:
      ...
      Write: "Restricted to docs/research/, data/research/, or embed/{agent}/ directories ONLY"
    ...
    forbidden_operations:
      - "Write to directories outside docs/research/, data/research/, or embed/{agent}/"
...
testing_framework:
  layer_1_unit_testing:
    research_output_validation:
      ...
      - "Validate output file created in allowed directories only (docs/research/, data/research/, or embed/{agent}/)"
