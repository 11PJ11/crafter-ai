...
description: DEPRECATED - Use nw-solution-architect-reviewer instead
model: haiku
---

# DEPRECATED

This agent has been migrated to v2 format. Use `nw-solution-architect-reviewer` instead.

Legacy copy preserved at: `nWave/agents/legacy/solution-architect-reviewer.md`
