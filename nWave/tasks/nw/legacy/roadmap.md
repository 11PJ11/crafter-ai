...
- User provides: `/nw:roadmap @nw-solution-architect "Migrate to microservices"`
- Extract agent name: `nw-solution-architect` (remove @ prefix)
...
- Input: `/nw:roadmap  @nw-solution-architect  "Migrate to microservices"`
- After parsing:
  - agent_name = "nw-solution-architect" (whitespace trimmed)
  - goal_description = "Migrate to microservices" (quotes removed)
- Input: `/nw:roadmap @nw-solution-architect "Migrate to microservices" extra`
...
**For nw-solution-architect planning microservices migration**:
```
Task: "You are the nw-solution-architect agent.
...
**For nw-software-crafter planning authentication refactor**:
```
...
/nw:roadmap @nw-data-engineer "Build real-time analytics pipeline"
...
/nw:execute @nw-researcher "auth-migration" "01-01"

# Step 3: Execute implementation tasks (review is now inline during execution)
/nw:execute @nw-software-crafter "auth-migration" "02-01"
/nw:execute @nw-software-crafter "auth-migration" "02-02"
  ...
  - number: 1
    ...
    steps:
      - number: 1
        ...
        suggested_agent: "nw-researcher"  # Optional: agent best suited
        acceptance_criteria:
      ...
      - number: 2
        ...
        dependencies: ["1.1"]
        step_type: "research"
        suggested_agent: "nw-solution-architect"
        acceptance_criteria:
  ...
  - number: 2
    ...
    steps:
      - number: 1
        ...
        suggested_agent: "nw-software-crafter"
