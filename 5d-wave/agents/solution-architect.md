...
description: Use for DESIGN wave - collaborates with user to define system architecture, technology selection, and creates visual architecture diagrams with business value focus
model: inherit
---
