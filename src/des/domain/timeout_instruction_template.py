...
"""
    ...
    def _render_turn_budget(self) -> str:
        ...
        return "**Turn Budget**: Aim to complete this task within approximately 50 turns."

    def _render_progress_checkpoints(self) -> str:
        """Render progress checkpoints with TDD phase mapping."""
        return """**Progress Checkpoints**: Track your progress against these milestones:
...
- Turn ~50: COMMIT phase starting (on track for completion)"""
    ...
    def _render_early_exit_protocol(self) -> str:
        ...
        return """**Early Exit Protocol**: If you cannot complete the task within the turn budget:
...
4. Do not continue if stuck - request human guidance"""
    ...
    def _render_turn_logging(self) -> str:
        ...
        return """**Turn Logging**: Log your turn count at each phase transition using this format:
