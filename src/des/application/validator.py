...
class ExecutionLogValidator:
    ...
    def validate(self, phase_log: List[dict], schema_version: str = "1.0") -> List[str]:
        ...
        present_phases = {
            phase.get("phase_name") for phase in phase_log if phase.get("phase_name")
        }
...
class TemplateValidator:
    ...
    def validate_prompt(self, prompt: str) -> ValidationResult:
        ...
        # NOTE: Execution log validation removed from prompt validation
        # Execution logs belong in step files and are validated by SubagentStopHook (US-003)
        # Prompts are templates and should not contain execution logs
