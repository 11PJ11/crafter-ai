# Journey: Build nWave Local Candidate (forge:build-local-candidate-candidate)
...
|   - Creates candidate: M.m.p-dev-YYYYMMDD-sequence                        |
|   - Example: 1.2.0 → 1.3.0-dev-20260131-1 → ... → 1.3.0-dev-20260131-5   |
...
|                                                        |  "Let's make sure
|  $ forge:build-local-candidate-candidate                         |   everything is ready"
|                                                        |
|  +--------------------------------------------------+  |
|  |  Forge: Build Local                              |  |
|  +--------------------------------------------------+  |
...
|                                                        |  "I know exactly
|  $ forge:build-local-candidate-candidate --force-version 2.0.0   |   what I want"
|                                                        |
|  +--------------------------------------------------+  |
...
|  |  Forced to:  2.0.0                               |  |
|  |                                                  |  |
|  |  Candidate:  2.0.0-dev-20260201-1                |  |
|  +--------------------------------------------------+  |
|                                                        |
...
| `${candidate_version}` | Generated: ${new_version}-dev-YYYYMMDD-sequence | Steps 2, 4, 5, 6 | HIGH - must match wheel filename |
| `${branch_name}` | git rev-parse --abbrev-ref HEAD | Step 2 | LOW - informational |
| `${daily_sequence}` | Counter for builds on same day | Step 2 | LOW - uniqueness |
...
| • 1.3.0-dev-20260131-N    |          | • Validates release readiness |
|                           |          | • Installs via pipx           |
