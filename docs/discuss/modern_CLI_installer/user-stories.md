...
#### Technical Notes
- Schema defined in: `docs/design/ux/shared/pre-flight-checks.yaml`
...
#### Technical Notes
- Schema defined in: `docs/design/ux/shared/doctor-health-check.yaml`
...
#### Technical Notes
- Schema defined in: `docs/design/ux/shared/shared-artifacts.yaml`
