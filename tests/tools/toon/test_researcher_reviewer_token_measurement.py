"""Tests for token measurement of researcher-reviewer agent conversion.
...
MD_SOURCE = Path("nWave/agents/researcher-reviewer.md")
TOON_SOURCE = Path("nWave/agents/researcher-reviewer.toon")
...
class TestBaselineStructure:
    ...
    def test_has_step_id(self, baseline_data):
        ...
        assert baseline_data["step_id"] == "02-04"

    def test_has_agent_name(self, baseline_data):
        """Must have agent name."""
        assert baseline_data["agent"] == "researcher-reviewer"
...
class TestComparisonStructure:
    ...
    def test_has_agent_name(self, comparison_data):
        """Must have agent name."""
        assert comparison_data["agent"] == "researcher-reviewer"
