"""Tests for token measurement of illustrator agent conversion.

Step 05-04 acceptance criteria validation:
...
MD_SOURCE = Path("nWave/agents/illustrator.md")
TOON_SOURCE = Path("nWave/agents/illustrator.toon")
...
class TestBaselineStructure:
    ...
    def test_has_step_id(self, baseline_data):
        ...
        assert baseline_data["step_id"] == "05-04"

    def test_has_agent_name(self, baseline_data):
        """Must have agent name."""
        assert baseline_data["agent"] == "illustrator"
...
class TestComparisonStructure:
    ...
    def test_has_step_id(self, comparison_data):
        """Must have step identifier."""
        assert comparison_data["step_id"] == "05-04"

    def test_has_agent_name(self, comparison_data):
        """Must have agent name."""
        assert comparison_data["agent"] == "illustrator"
