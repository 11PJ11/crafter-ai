"""
Tests for devop-reviewer token measurement and compression validation.
Step 08-04: Token measurement and compression validation for devop-reviewer.
...
BASELINE_FILE = "docs/feature/toon-agent-conversion/measurements/devop-reviewer-baseline.yaml"
COMPARISON_FILE = "docs/feature/toon-agent-conversion/measurements/devop-reviewer-comparison.yaml"
...
class TestBaselineStructure:
    ...
    def test_has_agent_name(self, baseline_data):
        ...
        assert baseline_data['agent_name'] == 'devop-reviewer'
...
class TestComparisonStructure:
    ...
    def test_has_agent_name(self, comparison_data):
        ...
        assert comparison_data['agent_name'] == 'devop-reviewer'
