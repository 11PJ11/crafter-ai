...
1. **Phase 1-2: Baseline Creation & Review**
   - Status: APPROVED
   - File: `docs/feature/des-us006/baseline.yaml`
...
2. **Phase 3-4: Roadmap Creation & Review**
   ...
   - File: `docs/feature/des-us006/roadmap.yaml`
...
3. **Phase 5: Split into Atomic Steps**
   - Status: COMPLETE
   - Files: `docs/feature/des-us006/steps/*.json` (30 files)
...
cat docs/feature/des-us006/.execution-order.txt

# Execute next step
/nw:execute @software-crafter "docs/feature/des-us006/steps/05-01.json"
