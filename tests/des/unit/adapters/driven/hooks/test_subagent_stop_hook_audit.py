...
Migrated from test_real_hook_audit.py (Schema v1.x).
"""
...
class TestSubagentStopHookAudit:
    """Test audit logging in SubagentStopHook.

    NOTE: Audit logging not yet implemented in SubagentStopHook.
    These tests are marked as skipped pending implementation.
    """

    @pytest.mark.skip(reason="Audit logging not yet implemented in SubagentStopHook")
    ...
    def test_logs_hook_subagent_stop_passed_on_success(
        ...
        # TODO: Verify audit log contains HOOK_SUBAGENT_STOP_PASSED
        # hook_calls = [
        #     call[0][0]
    ...
    def test_logs_hook_subagent_stop_failed_on_failure(
        ...
        # TODO: Verify audit log contains HOOK_SUBAGENT_STOP_FAILED
        # hook_calls = [
        #     call[0][0]
        #     for call in mock_audit_logger.append.call_args_list
    ...
    def test_includes_step_id_in_audit_entry(
        ...
        # TODO: Verify audit entry contains step_id
        # hook_calls = [
        #     call[0][0]
        #     for call in mock_audit_logger.append.call_args_list
    ...
    def test_includes_phases_validated_count(
        ...
        # TODO: Verify phases_validated count
        # hook_calls = [
        #     call[0][0]
        #     for call in mock_audit_logger.append.call_args_list
        #     if "HOOK_SUBAGENT_STOP" in call[0][0]["event"]
        ...
        # assert len(hook_calls) == 1
        # audit_entry = hook_calls[0]
        # assert audit_entry["phases_validated"] == 7
    ...
    def test_includes_validation_errors_on_failure(
        ...
        # TODO: Verify validation errors included
        # hook_calls = [
        #     call[0][0]
        #     for call in mock_audit_logger.append.call_args_list
        #     if call[0][0]["event"] == "HOOK_SUBAGENT_STOP_FAILED"
    ...
    def test_uses_time_provider_for_timestamp(
        ...
        # TODO: Verify timestamp from TimeProvider
